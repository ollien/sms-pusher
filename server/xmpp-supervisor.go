...
func NewXMPPSupervisor(xmppConfig config.XMPPConfig, recvChannel chan firebasexmpp.TextMessage, sendChannel chan firebasexmpp.OutboundMessage, logger *logrus.Logger) XMPPSupervisor {
