...
public class SystemProperties {
    ...
    private static final HashMap<String, MutableInt> sRoReads =
            TRACK_KEY_ACCESS ? new HashMap<String, MutableInt>() : null;
    ...
    //NOTE: Android Studio will show errors with this. It will still compile.
    //You can ignore errors about being unable to resolve JNI functions
